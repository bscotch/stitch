# [6.0.0](https://github.com/bscotch/stitch/compare/v5.1.0...v6.0.0) (2021-12-05)


### Bug Fixes

* The listener is not being properly passed to all resources. ([a976258](https://github.com/bscotch/stitch/commit/a9762581104f090b5b1af6872f4ae31512e578bb))


### Features

* Add type-discovery to the GMEdit types parser. ([0d78687](https://github.com/bscotch/stitch/commit/0d78687c32fab8f98b11fc1435f2d29b4eca9f06))
* Complete cleanup of parsed GMEdit type data. ([e217121](https://github.com/bscotch/stitch/commit/e217121bf81b9b582db36e4ec1cb86f89c5f047e))
* Complete initial typings. ([c747359](https://github.com/bscotch/stitch/commit/c74735952319c3640cb15a2b0e572cfb27a159ff))
* Create Typescript shim for GmlObjects. ([ee62f90](https://github.com/bscotch/stitch/commit/ee62f90b61a6fa64b362eddd2d232748aea0a6a8))
* Draft parser to create Typescript types from GMEdit types. ([c689d64](https://github.com/bscotch/stitch/commit/c689d646998642a88dc95348329567f28aa8073f))
* Get all constant values directly from GameMaker and save as types. ([e3006cf](https://github.com/bscotch/stitch/commit/e3006cf2ff2043d99241ccfefcf5765cba9cddf4))
* Resolve most remaining issues with GML types. ([dbdf23a](https://github.com/bscotch/stitch/commit/dbdf23ab2d421ca3a7ce249803df30f2d5d35d80))



# [5.1.0](https://github.com/bscotch/stitch/compare/v5.0.0...v5.1.0) (2021-11-04)
...
# [5.0.0](https://github.com/bscotch/stitch/compare/v4.0.0...v5.0.0) (2021-10-29)
...
# [4.0.0](https://github.com/bscotch/stitch/compare/v3.0.0...v4.0.0) (2021-10-28)
...
# [3.0.0](https://github.com/bscotch/stitch/compare/v2.13.0...v3.0.0) (2021-10-28)
...
# [2.13.0](https://github.com/bscotch/stitch/compare/v2.12.1...v2.13.0) (2021-09-21)
...
## [2.12.1](https://github.com/bscotch/stitch/compare/v2.12.0...v2.12.1) (2021-08-05)
...
# [2.12.0](https://github.com/bscotch/stitch/compare/v2.10.10...v2.12.0) (2021-08-04)


### Bug Fixes

* As with sprites, audio group assignments trigger multiple file-saves. This does not break GameMaker yet, but better to address this now. ([91dd0f6](https://github.com/bscotch/stitch/commit/91dd0f6f98174b6dfe48500b12a6b8a41a2846da))
* If a sprite is included in both a less- and more-specific texture page assignment, the sprite is first assigned to the less-specific one. The resulting file is correct, but GameMaker's file watcher gets triggered while it is temporarily incorrect, causing corruption. ([f49c6b6](https://github.com/bscotch/stitch/commit/f49c6b6dc2c075a2442b68d9a3cf64b70a5a1404))
* Logging got borked in the last update, causing only empty strings to be logged. ([1f6307d](https://github.com/bscotch/stitch/commit/1f6307d070110b0136d13680d26551a1e97007b8))
* Saves of partial changes to sprite YY files cause bad things to happen when the project is open in the GameMaker IDE. ([40ddc0e](https://github.com/bscotch/stitch/commit/40ddc0efb7bd238b4b73e74d1ba14a46e6f1a8db))
...
* The PR script cannot work with GitHub's branch rules. ([d541ea8](https://github.com/bscotch/stitch/commit/d541ea860b6047563aff3cce076ff6cae5f4fd5b))
* Update all deps and fix any resulting issues. ([462a8b6](https://github.com/bscotch/stitch/commit/462a8b67317182e38dac0e2c200b8b02daa523d0))
* When files are copied, the target is being deleted prior to the copy. This extraneous operation could trigger the GMS2 filewatcher, leading to weird results. ([cc31499](https://github.com/bscotch/stitch/commit/cc31499e0001dfc3fa5b5051c3fc7b0ff027bb26))


### Features

* Add config methods for finding the correct texture or audio group given a path. ([208bee9](https://github.com/bscotch/stitch/commit/208bee9879d7a4be81c15154392e087d4aa0d9ea))
* Add debug logging to the JSON file-writer to help discover unnecessary writes. ([dce0b65](https://github.com/bscotch/stitch/commit/dce0b6502a6ef5f1e4af1821e9a20f3eaf13c846))
* Add utility methods for determining relative proximity of a child to a parent path. ([db4e651](https://github.com/bscotch/stitch/commit/db4e651ced5d1f7cb9a4afccaf4fa920b9877837))
* Allow the NumberFixed class to use a function to determine number of decimals instead of a static number. ([4c97c4c](https://github.com/bscotch/stitch/commit/4c97c4cd93818350eaeba01257c7e9c09a42566e))
* Improve the stringification of Errors in the logging utilties. ([a1c001b](https://github.com/bscotch/stitch/commit/a1c001baee94c8d83535858d92f9f7627a928994))
...
* Reduce file writes during batch-adding of sounds by only updating the project yyp after all sounds are added. ([82c9b9f](https://github.com/bscotch/stitch/commit/82c9b9f079ee4226a060a4914c0f205e8efa48e4))
* Reduce file writes during batch-adding of sprites by only updating the project yyp after all sprites are added. ([f33d79b](https://github.com/bscotch/stitch/commit/f33d79b387c0a8efcfb2add92249b0810b579a3b))



## [2.10.10](https://github.com/bscotch/stitch/compare/v2.10.9...v2.10.10) (2021-06-20)


### Bug Fixes

* Another bug in the publishing workflow. ([7f08154](https://github.com/bscotch/stitch/commit/7f081540fa1132507177672328d38150d227f6d9))
* Another bug in the publishing workflow. ([7eb3d05](https://github.com/bscotch/stitch/commit/7eb3d0523f116664c38909bda7ce399c336d7866))
* **docs:** correct invalid instruction in programmatic use ([db458ef](https://github.com/bscotch/stitch/commit/db458ef322b821947ead0563956f892e4904ff76))
...
* The double-equal equality check does not work in sh, and setting the default to bash in the publish workflow did not make that run in bash. ([0d08887](https://github.com/bscotch/stitch/commit/0d0888777786945b0693436d30bbd89774ab860d))
* The git user/email is not set in the publish workflow, causing commit failure. ([70b1e81](https://github.com/bscotch/stitch/commit/70b1e810c7470a308131fec94689167691b6e464))
* The publish workflow has invalid syntax. ([f28116e](https://github.com/bscotch/stitch/commit/f28116e93dae275b32d38645af91785a2974ce77))
* The publish workflow is running on all pushes instead of just on develop. ([c4c3f16](https://github.com/bscotch/stitch/commit/c4c3f169e8e03255c2b27b4423725ccde4cc728f))
* The Publish workflow uses sh instead of bash by default, causing some commands to fail. ([f9c35a0](https://github.com/bscotch/stitch/commit/f9c35a0b6f292c3662b3a2e946b5c45b7c9e1f23))
* There is a syntax error in the publish workflow script, probably due to it using Node12. ([bd7fd10](https://github.com/bscotch/stitch/commit/bd7fd10f722e0e6d31fb17ee11f4ef60463a4249))


### Features

* Add basic workflow to run test suite on PR. ([71c71d4](https://github.com/bscotch/stitch/commit/71c71d4012c1d6304b0a87314c16d889cc2d81ec))
* Add CODEOWNERS file to streamline reviews. ([d287770](https://github.com/bscotch/stitch/commit/d2877707a83f0e06c302a1b0c84a403781fd5921))
