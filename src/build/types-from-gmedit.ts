...
const exportRawDir = 'gml/typings';
...
for (const patchFile of config.patchFiles) {
  ...
  for (let line of content.split(/[\r\n]+/)) {
    ...
    if (match) {
      ...
      // This is the sole broken function in the original
      // GMEdit source:
      //
      // object_get_parent<T extends obj, any extends obj>(ind:T): any;
      if(funcParts.name==='object_get_parent') {
        generics.splice(1);
      }
